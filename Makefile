...
export PYTHONPATH := .
test:
	@python3 -m unittest tests.test_rrm tests.test_mqtt_status tests.test_audit -v
smoke: test
	...
	@PYTHONPATH=. python3 examples/paho_unit.py
	@PYTHONPATH=. python3 examples/nats_roundtrip.py
